...
| 7 | [InfoPulse-PL](https://github.com/Swir/InfoPulse-PL) | `verified` | PR #1 → `1639025` |
...
|---|---|---|---|
| [Hex-kolor](https://github.com/Swir/Hex-kolor) | `main` | `verified` | PR #1 → `b0971040` |
...
| [Spamer](https://github.com/Swir/Spamer) | `main` | `verified` | PR #1 → `4e5773a`; controlled-use framing |
...
| [keygenerator](https://github.com/Swir/keygenerator) | `main` | `verified` | main `3671502`; safety-reviewed generator |
...
| [Ryzen-5-5600G-A320M-](https://github.com/Swir/Ryzen-5-5600G-A320M-) | `main` | `verified` | PR #1 → `ad653615`; docs CI passed; hardware-specific N/A scope; cleanup verified |
| [Procent-calkulator](https://github.com/Swir/Procent-calkulator) | `main` | `verified` | PR #1 → `be42f1f`; docs CI passed; v1.0.0 preserved; cleanup verified |
| [Swirui](https://github.com/Swir/Swirui) | `main` | `delegated` | Dedicated active development task owns documentation |
| [Ghost-APK-Builder](https://github.com/Swir/Ghost-APK-Builder) | `main` | `verified` | PR #9 → `64a74d08`; exact-head README Docs + Ghost v17 CI + package workflow passed; v17.0.0-beta.2 and documented 94% model preserved; cleanup verified |
...
- `Ryzen-5-5600G-A320M-`: PR #1 → `ad653615`; docs CI passed; README/card/generator read back on `main`; EFI/configuration behavior untouched; progress honestly N/A.
- `Procent-calkulator`: PR #1 → `be42f1f`; docs CI passed; README/card/generator read back on `main`; public v1.0.0 EXE/ZIP/SHA preserved; progress honestly N/A.
- `Ghost-APK-Builder`: PR #9 → `64a74d08`; README Docs, Ghost v17 CI and Windows package workflow all passed on the final PR head; v17.0.0-beta.2 and the existing documented 94% roadmap model preserved; legacy character meter retired from README/ROADMAP.
...
| 2026-09-18 | Migrated Ryzen-5-5600G-A320M-, Procent-calkulator and Ghost-APK-Builder. | 47 verified; cleanup 27; 2 queued remain. |
